...
<body>
            ...
            <div class="table">
                <table id="tabel">
                    ...
                    <tbody>
                        ...
                        $offset = ($page - 1) * $limit;
                        if ($_SESSION["role"] == '2') {
                            $query = "select post.post_id,post.title,post.description,post.post_date,category.category_name,user.user_name,post.category from post
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href='update_post.php?id=<?php echo $row["post_id"]; ?>'>
                                    ...
                                    <td>
                                        <a href='delete_post_code.php?id=<?php echo $row["post_id"]; ?>&catid=<?php echo $row["category"]; ?>&title=<?php echo $row["title"]; ?>' onclick='return confirmDelete("<?php echo $row["title"]; ?>");'>
                ...
                if (mysqli_num_rows($sql1) > 0) {
                    ...
                    if ($page > 1) {
                        echo '<li><a href="post.php?pages=' . ($page - 1) . '">&laquo; PREV</a></li>';
                    }
                    for ($i = 1; $i <= $total_pages; $i++) {
                        ...
                        echo '<li><a href="post.php?pages=' . $i . '" class="' . $active . '">' . $i . '</a></li>';
                    }
                    if ($total_pages > $page) {
                        echo '<li><a href="post.php?pages=' . ($page + 1) . '">NEXT &raquo;</a></li>';
                    }
                    echo '</ul>';
                }
                ?>
    ...
    <script>
        function confirmDelete(title) {
            var userConfirmed = window.confirm('Are you sure you want to delete the post: ' + title + ' ?');
