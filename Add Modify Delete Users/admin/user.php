...
<body>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='delete_user_code.php?id=<?php echo $row["user_id"]; ?>&username=<?php echo $row["user_name"]; ?>' onclick='return confirmDelete("<?php echo $row["user_name"]; ?>");'>
    ...
    <script>
        function confirmDelete(username) {
            var userConfirmed = window.confirm('Are you sure you want to delete the user: ' + username + ' ?');
